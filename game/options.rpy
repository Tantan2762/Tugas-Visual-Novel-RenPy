...
define config.name = _("Plants vs Zombies Visual Novel version")
...
define build.name = "PlantsvsZombiesVisualNovelversion"
...
define config.save_directory = "PlantsvsZombiesVisualNovelversion-1759048123"
